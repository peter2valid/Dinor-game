...
public class Cactus {
    ...
    private static final int CACTUS_DEFAULT_Y = Constants.SCREEN_HEIGHT - Constants.CACTUS_HEIGHT - 200;
    ...
    public void update() {
        x -= Constants.CACTUS_SPEED; // Move cactus leftward
        boundingBox.left = x;
    ...
    public Rect getBoundingBox() {
        // Slightly reduced hitbox for better gameplay feel
